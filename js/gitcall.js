$(function(){
    ...
    $('.startsurveybtn').on('click',function(e){
    	 ...
    	 $('.startsurvey').hide();
    	  ...
    	  user.agree = "Agreed";
    $.ajax({
        url: 'https://'+serverurl+':8443/UnusualGitCommit/participantid',
        type: 'POST',
        dataType: 'json',
		crossDomain: true,
  ...
  function requestJSON(url, callback) {
   ...
   //For building model
    ...
    $.ajax({
        url: 'https://'+serverurl+':8443/UnusualGitCommit/unusualcommitsurvey',
        type: 'POST',
        dataType: 'json',
		crossDomain: true,
...
function sendAjaxStatus(username, reponame) {
	...
	var CommitIn = new Object();
		...
		var ajax_call = function() {
			$.ajax({
		        url: 'https://'+serverurl+':8443/UnusualGitCommit/unusualcommitstatus',
		        type: 'POST',
		        dataType: 'json',
				crossDomain: true,
		        data: JSON.stringify(CommitIn),
    			...
    			for(j = 1; j<=5; j++) { 
				 ...
				 outdata = outdata + Date.now() +"\n"; 			 	 
 			 	 ...
 			 	 surveyclass.data = outdata;
 			 	    ...
 			 	    $.ajax({
        url: 'https://'+serverurl+':8443/UnusualGitCommit/presurvey',
        type: 'POST',
        dataType: 'json',
		crossDomain: true,
